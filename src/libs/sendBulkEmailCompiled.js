...
var _require2 = require("./sendEmail"),
  sendEmail = _require2.sendEmail;
var ReactDOMServer = require("react-dom/server");
var React = require("react");
var DatoCuriosoEmail = require("../emails/datocurioso")["default"];
var sendBulkEmail = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(subject) {
    var subscribers, htmlContent, _iterator, _step, subscriber;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 5:
          ...
          htmlContent = ReactDOMServer.renderToStaticMarkup( /*#__PURE__*/React.createElement(DatoCuriosoEmail, null));
        ...
        case 27:
          ...
          console.error("Error al enviar correos", _context.t1);
        case 30:
        case "end":
  ...
  return function sendBulkEmail(_x) {
